permut_list = [
    [r"\x48\x31\xc0", r"\x48\x89\xc0", r"\x48\x29\xc0", r"\x48\x83\xe0\xff", r"\x48\x89\xc0\x48\x31\xc0"], # XOR RAX
    [r"\x48\x31\xdb", r"\x48\x89\xdb", r"\x48\x29\xdb", r"\x48\x83\xe3\xff", r"\x48\x89\xdb\x48\x31\xdb"], # XOR RBX
    [r"\x48\x31\xc9", r"\x48\x89\xc9", r"\x48\x29\xc9", r"\x48\x83\xe1\xff", r"\x48\x89\xc9\x48\x31\xc9"], # XOR RCX
    [r"\x48\x31\xff", r"\x48\x89\xff", r"\x48\x29\xff", r"\x48\x83\xe7\xff", r"\x48\x89\xff\x48\x31\xff"], # XOR RDI
    ...
    [r"\x48\x31\xf6", r"\x48\x29\xf6", r"\x48\x89\xf6", r"\x48\x83\xe6\xff", r"\x48\x89\xf6\x48\x31\xf6"], # XOR RSI
    [r"\x48\xf7\xe6"], # MUL RSI
    [r"\x04\x29", r"\xb0\x2f\x2c\x06", r"\xb0\x3a\x2c\x11", r"\xb0\x38\x2c\x0f", r"\xb0\x30\x2c\x01", r"\xb0\x35\x2c\x0c", r"\xb0\x2a\x2c\xfd"],     # ADD AL, 0x29
    [r"\x48\xff\xc6", r"\x48\xff\xc6\x48\xff\xce\x48\xff\xc6", r"\x48\x83\xc6\x01\x48\x83\xee\x01\x48\x83\xc6\x01"], # INC RSI
    [r"\x56"],         # PUSH RSI
    [r"\x5f"],         # POP RDI
